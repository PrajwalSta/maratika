    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="POST" action="{{route('saveOnroadKeyInfo')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
              ...
              <select name="icon" id="icon">
                ...
                <input type="hidden" name="tour_id" value="{{$onroadKeyId}}"> 
          </div>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">OnRoad Key Information
        ...
        @endif
              ...
              <div class="col-sm-12">
                  ...
                  @endswitch
                          ...
                          <a href="/edit-OnroadKeyInfo/{{ $keyinfo->id }}" class="btn mt-0" style="color: white;">
                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                          </a>
                        
                       
                  <form action="/delete-Onroadkeyinfo/{{ $keyinfo->id }}" method="post" class="form-horizontal">
                    @csrf
                        @method('delete')
