...
<div class="col-12 mt-5">
  ...
  <h1>Onroad Events For Calendar</h1>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="POST" action="{{route('saveonroadEvents')}}">
            @csrf
            ...
            <input type="hidden" name="onroadtour_id" value="{{$onroadEventsId}}">
            <div class="form-group">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="/delete-onroadEvents/{{ $event}}" method="post" class="form-horizontal">
            @csrf
                @method('delete')
              ...
              <div class="col-12 d-flex">
                @if(!($event->status))
                  ...
                  @endif
                    ...
                    <a href="/edit-onroadEvents/{{$event->id}}/{{$onroadEventsId}}" class="btn mt-0"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                  
                 
            <form action="/delete-onroadEvents/{{ $event->id }}" method="post" class="form-horizontal">
              @csrf
                  @method('delete')
