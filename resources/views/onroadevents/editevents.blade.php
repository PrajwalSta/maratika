...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
               <form action="/markbooked-onroadevents/{{ $event->id}}/{{$tourid}}" method="post">
                                   @csrf
                    @method('PUT')
                    @if($event->status)
            ...
            <form action="/update-onroadevents/{{ $event->id}}/{{$tourid}}" method="post">
                    @csrf
                    @method('PUT')
              ...
              <input type="text" class="form-control" id="event_links" name="event_links" value="{{$event->event_links}}">
                        ...
                        <input type="color" class="form-control" id="color" name="color" value="{{ $event->color}}">
                          ...
                          <input type="text" class="form-control" id="endDate" name="endDate" value="{{ $event->end_date }}">
                          </div> 
