    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="POST" action="{{route('saveroomItinerary')}}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="image" class="col-form-label">Any Image Available(optional):</label>
                <input type="file" class="form-control" id="image" name="image">
              </div>
              <input type="hidden" name="id" value="{{$roomitineraryId}}">
...
<div class="row">
 ...
 <div class="card-body">
  ...
  <div class="p-5 " style="width:30%;height:30%">
    <img src="../../uploads/roomitinerary/{{ $itinerary->itinerary_image }}" alt="" srcset=""> 

    <form action="/delete-roomitinerary/{{$itinerary->id}}" method="post" class="form-horizontal">
      @csrf
          @method('delete')
